...
- JMA is a separate format at version 1; trace JSON records use schema version `1.2.0` and do not change `.jam` v3.
...
- Accession-backed controlled spike-ins, local range/memory measurements, and
  pinned BLASTn/minimap2 comparisons are recorded with bounded claims.
